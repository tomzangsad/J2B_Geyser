...
then
  ...
  printf "\e[3m\e[37m"
  echo
  COLUMNS=$COLUMNS-1 curl --no-styled-output -#L -o default_assets.zip https://github.com/ZtechNetwork/MCBVanillaResourcePack/tags/${default_asset_version:=v1.20.30}
  echo
  printf "${C_CLOSE}"
